...
* **Receipt Scanning (Image Recognition):** Add groceries to your inventory by taking a photo of your receipt. 
* **Inventory Tracking:** Keep a real-time log of what's in your kitchen, categorized for easy browsing.
* **Expiry Date Monitoring:** Get automated alerts before food goes bad, directly contributing to reducing household food waste.
* **AI-Powered Recipe Recommendations:** Generate custom meal ideas based exclusively on the ingredients you need to use up first.
